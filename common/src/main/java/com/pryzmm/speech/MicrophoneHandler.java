...
public class MicrophoneHandler {
    ...
    public byte[] readData() {           // Read audio data
        byte[] buffer = new byte[ShriekConstants.cacheSize];        // The size of the cache used to store audio data, use bytes as the unit, the default is 4096 bytes
